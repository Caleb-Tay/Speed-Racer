class Game {
  constructor() {
    ...
    this.leadeboardTitle = createElement("h6");
  ...
  handleElements() {
    ...
    this.resetButton.position(width / 2 + 230, 180);
  ...
  showLife(){
    ...
    fill("white");
    rect(width / 2 -200 , height - player.positionY - 400 , 185 , 20);
    fill("blue");
